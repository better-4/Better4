...
better4_control_revert = {
  ...
  ini_key = "Revert"
  options = [
    { text = "R2/L2" value = RevertVanilla } // 0
    { text = "R2" value = RevertOnlyR2 } // 1
    { text = "L2" value = RevertOnlyL2 } // 2
    { text = "R2+L2" value = RevertR2andL2 } // 3
    { text = "R1/L1" value = RevertOnlyR1 } // 4
    { text = "R1" value = RevertOnlyL1 } // 5
    { text = "L1" value = RevertR1andL1 } // 6
    { text = "R1+L1" value = RevertR1orL1 } // 7
  ]
}
...
better4_control_powerslide = {
  ...
  ini_key = "Powerslide"
  options = [
    { text = "D+R1+L1" value = PowerslideVanilla } // 0
    { text = "D+R2+L2" value = PowerslideDownR2L2 } // 1
    { text = "D+R2" value = PowerslideDownR2 } // 2
    { text = "D+R1" value = PowerslideDownR1 } // 3
    { text = "R2" value = PowerslideR2 } // 4
    { text = "L2" value = PowerslideL2 } // 5
    { text = "R1" value = PowerslideR1 } // 6
    { text = "L1" value = PowerslideL1 } // 7
  ]
}
...
better4_control_stancechange = {
  ...
  options = [
    { text = "L2" value = NollieL2 } // 0
    { text = "Off" value = NoTricks } // 1
  ]
}
...
better4_control_jumptrick = {
  ...
  ini_key = "Jumptrick"
  options = [
    { text = "Boneless" value = JumptrickBoneless } // 0
    { text = "Beanplant" value = JumptrickBeanplant } // 1
    { text = "Fastplant" value = JumptrickFastplant } // 2
    { text = "MikeV" value = JumptrickMikeVBoneless } // 3
  ]
}
...
better4_control_dropdown = {
  ...
  ini_key = "Dropdown"
  options = [
    { text = "R2/L2" value = DropdownVanilla } // 0
    { text = "R2" value = DropdownOnlyR2 } // 1
    { text = "L2" value = DropdownOnlyL2 } // 2
    { text = "R2+L2" value = DropdownR2andL2 } // 3
    { text = "R1/L1" value = DropdownR1orL1 } // 4
    { text = "R1" value = DropdownOnlyR1 } // 5
    { text = "L1" value = DropdownOnlyL1 } // 6
    { text = "R1+L1" value = DropdownR1andL1 } // 7
  ]
}
...
better4_control_wallieplant = {
  ...
  ini_key = "Wallieplant"
  options = [
    { text = "U+U+X" value = WallieplantTricks } // 0
    { text = "U+X" value = WallieplantTricks_Single } // 1
  ]
}
...
script better4_control_init // <control...>
  <index> = <index_name>
...
script better4_control_cycle // <delta>, <control...>
  <index> = <index_name>
...
script better4_control_change // <new_index>, <control...>
...
script better4_control_menu_cycle // <delta>, <control...>
...
script better4_control_menu_cycle_right // <delta>, <control...>
  better4_control_menu_cycle <...> delta = 1
endscript

script better4_control_menu_cycle_left // <delta>, <control...>
  better4_control_menu_cycle <...> delta = -1
endscript
